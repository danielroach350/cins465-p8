class WeathersController < ApplicationController
  ...
  private
    ...
    def weather_params
      params.require(:weather).permit(:weather_info, :fish_id, :currentTime, :moonPercentage, :location, :zipCode, :elevation, :observationLocation, :observationLocationElevation, :observationTime, :currentWeather, :temperature, :relative_humidity, :windInformation, :precipToday)
    end
end
